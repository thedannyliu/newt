...
| Subset20 10M high-step | 20 | 10M target + 50k demo | MLP | flow | A100 | resubmitted | 9.0M | 0.60928 | Best subset20 MLP+flow snapshot so far; preempted and resubmitted as `9820443_[1]`. |
